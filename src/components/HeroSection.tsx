    ...
    return(
        <div className="w-full ">
            <div className="container">
                <div className=" items-center md:flex text-black md:space-x-[100px] justify-center mt-[120px] mb-[120px]">
                    <div className="max-w-2xs space-y-4">
                        ...
                        <div className="flex space-x-5">
                            ...
                            <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-circle-icon lucide-message-circle"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/></svg></a>
                        </div>
